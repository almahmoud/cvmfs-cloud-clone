...
tar -zcvf /mnt/archives/contents.tar.gz $LOCAL_CVMFS_PATH/ && \
tar -zcvf /mnt/archives/startup.tar.gz /startup/cvmfs/cloud.galaxyproject.org/ && \
tar -zcvf /mnt/archives/partial.tar.gz /partial/cvmfs/cloud.galaxyproject.org/
